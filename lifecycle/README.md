# Java Client For Nutanix Lifecycle Versioned APIs

The Java client for Nutanix Lifecycle Versioned APIs is designed for Java client application developers offering them simple and flexible access to APIs that manage Infrastructure, Software and Firmware Upgrades.
## Features
...
<dependency>
  ...
  <artifactId>lifecycle-java-client</artifactId>
...
```groovy
dependencies {
    implementation("com.nutanix.api:lifecycle-java-client:4.0.1-beta-1")
}
```

## Configuration

The Java client for Nutanix Lifecycle Versioned APIs can be configured with the following parameters
...
import com.nutanix.lif.java.client.ApiClient;
import com.nutanix.lif.java.client.api.SampleApi;
...
public class Sample {
  public void performOperation() {
    ...
    String null = "string_sample_data";
    String null = "string_sample_data";
    ListEntitiesApiResponse listEntitiesApiResponse = entitiesApi.listEntities(page, limit, null, null, null);
  }
}
```
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=lifecycle&version=v4.0.b1&language=java). This documentation is auto-generated, and the location may change.
