...
```groovy
dependencies {
    implementation("com.nutanix.api:networking-java-client:4.0.1-beta-1")
}
```
...
```java
import com.nutanix.net.java.client.ApiClient;
import com.nutanix.net.java.client.api.BgpSessionsApi;
import com.nutanix.dp1.net.networking.v4.config.ListBgpSessionsApiResponse;
...
public class Sample {
  public void performOperation() {
    ...
    String null = "string_sample_data";
    String null = "string_sample_data";
    ListBgpSessionsApiResponse listBgpSessionsApiResponse = bgpSessionsApi.listBgpSessions(page, limit, null, null, null);
  }
}
```
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=networking&version=v4.0.b1&language=java). This documentation is auto-generated, and the location may change.
