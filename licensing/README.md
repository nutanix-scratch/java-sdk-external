# Java Client For Nutanix Licensing Versioned APIs

The Java client for Nutanix Licensing Versioned APIs is designed for Java client application developers offering them simple and flexible access to APIs that licensing desc placeholder.
## Features
...
<dependency>
  ...
  <artifactId>licensing-java-client</artifactId>
...
```groovy
dependencies {
    implementation("com.nutanix.api:licensing-java-client:4.0.1-beta-1")
}
```

## Configuration

The Java client for Nutanix Licensing Versioned APIs can be configured with the following parameters
...
```java
import com.nutanix.lic.java.client.ApiClient;
...
import com.nutanix.lic.java.client.ApiClient;
import com.nutanix.lic.java.client.api.SampleApi;
...
```java
import com.nutanix.lic.java.client.ApiClient;
import com.nutanix.lic.java.client.api.LicensesApi;
import com.nutanix.dp1.lic.licensing.v4.config.ListFeaturesApiResponse;
...
public class Sample {
  public void performOperation() {
    ...
    // Configure the client
    // ...
    LicensesApi licensesApi = new LicensesApi(client);
    int page = 0;
    int limit = 50;
    String null = "string_sample_data";
    String null = "string_sample_data";
    String null = "string_sample_data";
    ListFeaturesApiResponse listFeaturesApiResponse = licensesApi.listFeatures(page, limit, null, null, null);
  }
}
```
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=licensing&version=v4.0.a1&language=java). This documentation is auto-generated, and the location may change.
