...
The Java client for Nutanix Iam Versioned APIs is designed for Java client application developers offering them simple and flexible access to APIs that manage Identity and Access Management of Nutanix clusters.
## Features
...
```groovy
dependencies {
    implementation("com.nutanix.api:iam-java-client:4.0.1-beta-1")
}
```
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=iam&version=v4.0.b1&language=java). This documentation is auto-generated, and the location may change.
